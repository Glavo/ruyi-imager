...
- `./gradlew -g .gradle-user-home :app:test --tests org.glavo.ruyi.imager.gui.MainWindowJavaFxSmokeTest.usesApplicationFontInMaterialFxSelectors`
- `./gradlew -g .gradle-user-home cleanTest check`
- `git diff --check`
