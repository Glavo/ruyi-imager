...
- GitHub Actions 已接入 nightly release workflow：每天定时或手动构建 Windows x86_64、Linux x86_64 和 macOS aarch64 JLink zip，更新固定 `nightly` prerelease 的说明、tag 和 assets，并附带 SHA-256 校验文件。
