...
- `./gradlew -g .gradle-user-home -q "-Pruyi.version=1.0.0-nightly.42+3921d84" properties`
- `./gradlew -g .gradle-user-home "-Pruyi.version=1.0.0-nightly.42+3921d84" "-Pjlink.jdk.platform=windows-x86_64" :app:jlinkArchive :app:jlinkMsi :app:jlinkSetupExe --dry-run`
- `./gradlew -g .gradle-user-home "-Pruyi.version=1.0.0-nightly.42+3921d84" "-Pjlink.jdk.platform=linux-x86_64" :app:jlinkArchive :app:jlinkDeb --dry-run`
...
- `./gradlew -g .gradle-user-home "-Pruyi.version=1.0.0-nightly.42+3921d84" "-Pjlink.jdk.platform=windows-x86_64" :app:jlinkSetupExe --dry-run`
- `./gradlew -g .gradle-user-home "-Pjlink.jdk.platform=windows-x86_64" :app:writeJlinkWixBundleSource -x :app:jlinkMsi --rerun-tasks`
...
- Local update manifest CLI channel check: `check-update --channel nightly` selects `1.1.0-nightly.2+local`.
- `git diff --check`
