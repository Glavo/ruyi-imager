...
- `./gradlew -g .gradle-user-home -q "-Pruyi.commitVersion=true" "-Pruyi.commit=3921d84abcdef" properties`
- `./gradlew -g .gradle-user-home "-Pruyi.commitVersion=true" "-Pruyi.commit=3921d84abcdef" "-Pjlink.jdk.platform=windows-x86_64" :app:jlinkArchive :app:jlinkMsi :app:jlinkSetupExe --dry-run`
- `./gradlew -g .gradle-user-home "-Pruyi.commitVersion=true" "-Pruyi.commit=3921d84abcdef" "-Pjlink.jdk.platform=linux-x86_64" :app:jlinkArchive :app:jlinkDeb --dry-run`
- `git diff --check`
