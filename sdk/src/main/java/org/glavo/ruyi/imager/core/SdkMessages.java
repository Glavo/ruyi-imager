...
public final class SdkMessages {
    ...
    private static final @Unmodifiable Map<String, String> MESSAGES = Map.ofEntries(
            ...
            Map.entry("core.repo.cloneSourcesFailed", "Failed to clone Ruyi repo {0} from all {1} configured sources: {2}"),
            Map.entry("core.repo.updating", "Updating Ruyi repo {0}"),
            Map.entry("core.repo.tryingFallback", "Retrying Ruyi repo {0} with a fallback source"),
            ...
            Map.entry("core.repo.updateSourcesFailed", "Failed to update Ruyi repo {0} from all {1} configured sources: {2}"),
            ...
            Map.entry("core.flash.emptyImage", "Refusing to write an empty image: {0}"),
            ...
            Map.entry("core.dd.eventLogLimit", "dd-flasher event log has more than {0} unconsumed bytes."),
            Map.entry("core.dd.eventLineLimit", "dd-flasher event log contains a line longer than {0} bytes."),
            ...
            Map.entry("core.download.sizeExceeded", "Distfile {0} exceeded its declared size of {1} bytes."),
